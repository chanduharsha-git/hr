...
import com.bastech.hr.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.bastech.hr.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "hrEmployee";
